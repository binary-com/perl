...
"x86_64-linux-5.10.0-22-cloud-amd64" or
	die "Errno architecture (x86_64-linux-5.10.0-22-cloud-amd64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
