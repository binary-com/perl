...
cf_time='Fri May 18 05:25:50 UTC 2018'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg18='-Uusenm'
config_arg19='-Uuseithreads'
config_arg2='-Dinc_version_list=none'
config_arg20='-Uusemultiplicity'
config_arg21='-Ui_libutil'
config_arg22='-DDEBUGGING=-g'
config_arg23='-Doptimize=-O2'
...
config_argc='25'
config_args='-Dusesitecustomize -Dinc_version_list=none -Dprefix=/home/git/binary-com/perl -Dotherlibdirs=/home/git/regentmarkets/cpan/local/lib/perl5/ -Duselargefiles -Dccflags=-DDEBIAN -D_FORTIFY_SOURCE=2 -g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security -Dldflags= -Wl,-z,relro -Dlddlflags=-shared -Wl,-z,relro -Dcccdlflags=-fPIC -Duse64bitint -Dman1ext=1 -Dman3ext=3perl -Dpager=/usr/bin/sensible-pager -Uafs -Ud_csh -Ud_ualarm -Uusesfio -Uusenm -Uuseithreads -Uusemultiplicity -Ui_libutil -DDEBUGGING=-g -Doptimize=-O2 -Duseshrplib -des'
contains='grep'
cp='cp'
cpio=''
cpp='cpp'
