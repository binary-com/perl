...
"x86_64-linux-4.19.0-10-cloud-amd64" or
	die "Errno architecture (x86_64-linux-4.19.0-10-cloud-amd64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
