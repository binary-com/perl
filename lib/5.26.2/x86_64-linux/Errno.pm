...
"x86_64-linux-6.8.0-1021-azure" or
	die "Errno architecture (x86_64-linux-6.8.0-1021-azure) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
