...
"x86_64-linux-6.17.0-1022-azure" or
	die "Errno architecture (x86_64-linux-6.17.0-1022-azure) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
