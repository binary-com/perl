...
"aarch64-linux-5.3.0-46-generic" or
	die "Errno architecture (aarch64-linux-5.3.0-46-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
