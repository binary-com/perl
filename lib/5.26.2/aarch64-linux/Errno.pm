...
"aarch64-linux-6.4.16-linuxkit" or
	die "Errno architecture (aarch64-linux-6.4.16-linuxkit) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
