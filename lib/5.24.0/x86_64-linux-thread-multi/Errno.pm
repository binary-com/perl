...
"x86_64-linux-thread-multi-3.2.0-4-amd64" or
	die "Errno architecture (x86_64-linux-thread-multi-3.2.0-4-amd64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
