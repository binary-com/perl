...
"x86_64-linux-3.16.0-0.bpo.4-amd64" or
	die "Errno architecture (x86_64-linux-3.16.0-0.bpo.4-amd64) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
