...
"x86_64-linux-4.9.7-040907-lowlatency" or
	die "Errno architecture (x86_64-linux-4.9.7-040907-lowlatency) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
